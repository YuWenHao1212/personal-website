---
title: "Why I Left Roam Research After 5 Years (And Switched to Obsidian)"
...
Vannevar Bush, an American scientist, published "[As We May Think](https://www.theatlantic.com/magazine/archive/1945/07/as-we-may-think/303881/)" in The Atlantic. He imagined a machine called **Memex**—a device that could store everything you read and let you create "trails" between pieces of information.
...
Then Sönke Ahrens published *[How to Take Smart Notes](https://www.amazon.com/How-Take-Smart-Notes-Nonfiction/dp/1542866502)*. He made Zettelkasten systematic, practical, and actionable.
...
[**Roam Research**](https://roamresearch.com/) (2019) brought **bidirectional links** to mainstream note-taking. Traditional notes: A links to B, but B doesn't know A exists. Bidirectional links: A links to B, and B automatically shows "A linked to me."
...
[**Obsidian**](https://obsidian.md/) (2020) launched the same year with a different philosophy: **local-first**. Your notes are plain Markdown files on your computer. No cloud dependency.
