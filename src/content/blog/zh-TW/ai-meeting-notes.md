...
faq:
  - question: "這個工具的成本是多少？"
    answer: "一小時會議約 $0.32 美元（約 10 元台幣）。因為我本來就用 Claude Code 訂閱方案工作，逐字稿清理、會議摘要、即時戰術顧問都包含在訂閱裡，唯一的額外成本是語音轉文字（~$0.32/hr）。"
  - question: "跟 Otter.ai、Fireflies 這些工具有什麼不同？"
    answer: "市面 SaaS 月費 $10-30，提供轉錄和摘要。這個工具多了即時 AI 戰術顧問——開會時 one click 就能根據你的 playbook 和現場對話取得建議。而且資料全部在本地處理，不經過第三方。"
...
![Meeting Transcriber 三欄式介面](/images/blog/ai-meeting-notes.webp)
...
| 工具 | 月費 | 會前準備 | 即時建議 | 資料處理 |
|------|------|---------|---------|---------|
| Otter.ai | $16.99/月 | 無 | 無 | 雲端 |
| Fireflies | $18/月 | 無 | 無 | 雲端 |
| Krisp | $16/月 | 無 | 無 | 雲端 |
| Jamie | €25/月 | 無 | 無 | 雲端 |
| **這個工具** | **$0.32/hr** | **AI 自動生成 playbook** | **即時戰術顧問** | **全部本地** |

這些工具做的是「會中轉錄 + 會後摘要」。我的工具多了兩層：會前 AI 自動從行事曆、email、專案進度生成 playbook，會中根據 playbook 和即時對話給出戰術建議——而且跑的是 Claude Opus，Anthropic 最頂級的推理模型。所有資料都在本地處理，會議內容不經過第三方伺服器。
...
我的 AI 工作流已經接上了 email、目標管理、知識庫、內容創作——我把它叫做[可程式化工作流](/zh-TW/blog/personal-panopticon/)。但之前每次開完會，還是得自己整理筆記。這個洞一直在漏水。四小時做的 prototype，把它補上了。

做完之後順手跟幾個朋友聊到這個東西。沒想到每次提到，對方都問同一句話：「這個能不能用在我們公司？」目前還是 prototype，從一個人的工具到一個產品，中間還有一段路。但如果你也覺得這個東西該存在——不管是想當早期用戶、企業導入、還是一起把它做出來——[跟我聊聊](mailto:mail@yu-wenhao.com)。
