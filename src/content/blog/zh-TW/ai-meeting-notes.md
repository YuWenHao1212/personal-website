...
faq:
  ...
  - question: "跟 Otter.ai、Fireflies 這些工具有什麼不同？"
    answer: "市面 SaaS 月費 $10-30，提供轉錄和摘要。這個工具多了即時 AI 戰術顧問——開會時 one click 就能根據你的 playbook 和現場對話取得建議。錄音檔和會議記錄全部留在本機，不存在第三方雲端儲存。"
...
| Krisp | $16/月 | 無 | 無 | 雲端 |
| Jamie | €25/月 | 無 | 無 | 雲端 |
| **這個工具** | **$0.32/hr** | **AI 自動生成 playbook** | **即時戰術顧問** | **本地儲存** |
...
做完之後跟幾個朋友聊到，有人問能不能用在他們公司，也有人想自己用。老實說，目前這是為我自己做的 prototype——要變成產品，要處理的東西完全不同：更多使用場景、邊界情況、穩定性、部署方式。我還在評估值不值得投入這段路。如果你覺得這個工具該存在，[花三十秒讓我知道](/zh-TW/survey/ai-meeting-tool/)。
