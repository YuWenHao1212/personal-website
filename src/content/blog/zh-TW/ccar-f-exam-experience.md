...
lang: zh-TW
featured: true
heroImage: /images/blog/ccar-f-exam-experience.webp
...
faq:
  ...
  - question: "CCAR-F 證照會過期嗎？"
    answer: "會，效期是取得後 12 個月。到期前續證免費，做一份不用監考的線上評量就好，內容是這段期間官方改了什麼；放到過期，就得重新報名完整的監考考試、付全額費用。2026 年 6 月 30 日前取得的證書原本效期 6 個月，已自動延長為 12 個月。"
---

11 點 45 分，新竹光復路的帝國大樓三樓。我把印出來、寫滿決策樹的複習頁最後掃了一遍，跟手機、手錶、口袋裡所有東西一起鎖進置物櫃。兩小時後，螢幕跳出成績：882，及格線 720。

![CCAR-F 成績單：及格線 720、實得 882、Pass（2026-08-24）](/images/blog/ccar-f-exam-experience-score.png)

這場考的是 CCAR-F，Anthropic 的架構師認證。我從 2025 年 6 月開始用 Claude Code 開發產品，後來連生活和公司的日常運作也搬了上去；現在的工作環境以 Anthropic 生態系為主，也在企業內訓和公開班教 [Claude Code](/zh-TW/blog/claude-code-tutorial/) 應用。所以這張證照 3 月一公開我就想考；真正埋頭準備的時間，前後一個多月。
...
![CCAR-F 備考流程圖：打底、練習迴圈、三關驗收](/images/blog/ccar-f-exam-experience-flowchart.png)
...
這張 badge 不是永久的：[官方認證 FAQ](https://anthropic-partners.skilljar.com/page/faq-certifications)寫明效期 12 個月，我這張 2027 年 8 月 24 日到期。到期前續證免費，做一份不用監考的線上評量就好；放到過期，就得重新報名完整的監考考試、付全額費用。
