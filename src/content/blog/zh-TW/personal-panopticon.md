...
這套系統我叫它 **FLUX**：方向（Focus）→ 系統（Learn/Upgrade）→ 槓桿（eXecute）三層架構。這篇講的是 FLUX 怎麼在我每天工作裡跑；如果你想看[論點為什麼是「方向先、AI 最後」](/zh-TW/blog/flux-direction-system-leverage/)，那是另一篇。
...
> **不想自己摸三個月？** **10/24（六）台北第四班招生中**——6 小時實作工作坊、從零建好 Claude Code + Obsidian 的個人指揮中心（FLUX 系統）：目標追蹤、知識庫、自動化腳本，帶著能跑的系統回家。[看工作坊詳情 →](/zh-TW/workshop/)
