...
這不只是我在現場看到的。[McKinsey 2025 年調查](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai)發現，88% 的企業已經在用 AI，但只有不到 6% 真正產生顯著財務回報。工具到位了，但流程沒跟上，價值就出不來。
...
前者太輕，後者太重。但兩條路的問題其實一樣——[Gartner](https://www.gartner.com/en/newsroom/press-releases/2024-07-29-gartner-predicts-30-percent-of-generative-ai-projects-will-be-abandoned-after-proof-of-concept-by-end-of-2025) 發現，30% 的生成式 AI 專案在概念驗證後就被放棄，到了 AI Agent 時代[這個比例升到 40%](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027)。不是技術不行，是沒有搞清楚拿它來做什麼。

員工拿到帳號了。打開 ChatGPT，問一個問題，複製貼上答案。然後關掉。

[Deloitte 2026 年報告](https://www.deloitte.com/us/en/what-we-do/capabilities/applied-artificial-intelligence/content/state-of-ai-in-the-enterprise.html)的數字印證了這個現象：即使企業發了 AI 工具，不到六成員工真的在日常工作中使用。用的人也多半是單點操作——用 ChatGPT 問問題、用 AI 做簡報——工具之間還是斷開的，資料還是靠人搬，綜效起不來。
