...
(function () {
  ...
  function makeButton(target) {
    ...
    // 2026-09-10：匯流 .copybox 自帶 head 列的 .copybtn，直接綁；其他 [data-copy] 舊殼才注入右上角按鈕
    var own = target.classList.contains('copybox') ? target.querySelector('.copybtn') : null;
    var btn = own;
    if (!btn) {
